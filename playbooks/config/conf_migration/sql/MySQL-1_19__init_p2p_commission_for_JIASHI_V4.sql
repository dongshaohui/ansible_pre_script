...
VALUES ('P2P_COMMISSION', 1, 'JIASHI_V4', 'SIGN', 'var config = JSON.parse(agreement.getConfig());
...
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('P2P_COMMISSION', 1, 'JIASHI_V4', 'PREPAYMENT', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('P2P_COMMISSION', 1, 'JIASHI_V4', 'OVERDUE', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('P2P_COMMISSION', 1, 'JIASHI_V4', 'VALIDATE', '//not needed');