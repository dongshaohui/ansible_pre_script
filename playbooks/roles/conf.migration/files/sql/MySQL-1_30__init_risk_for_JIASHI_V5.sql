INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE) VALUES ('RISK', 1, 'JIASHI_V5', 'SIGN', 'var config = JSON.parse(agreement.getConfig());
...
VALUES ('RISK', 1, 'JIASHI_V5', 'PREPAYMENT', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('RISK', 1, 'JIASHI_V5', 'OVERDUE', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('RISK', 1, 'JIASHI_V5', 'VALIDATE', '//not needed');