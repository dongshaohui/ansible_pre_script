INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE) VALUES ('RISK', 1, 'JIASHI_V3', 'SIGN', 'var config = JSON.parse(agreement.getConfig());
...
VALUES ('RISK', 1, 'JIASHI_V3', 'PREPAYMENT', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('RISK', 1, 'JIASHI_V3', 'OVERDUE', '//not needed');
INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE)
VALUES ('RISK', 1, 'JIASHI_V3', 'VALIDATE', '//not needed');