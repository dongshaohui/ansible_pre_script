...
{   
	...
	scp root@10.139.105.230:/mvp-dev/chinapay-deposit/build/libs/chinapay_deposit_scheduler-standalone.jar ./playbooks/config/chinapay_deposit_scheduler/jar/ 
...
{   
    ...
    scp root@10.139.105.230:/mvp-dev/scheduler/build/libs/contract_settle_scheduler-standalone.jar ./playbooks/config/contract_settle_scheduler/jar/ 
...
{   cp ./playbooks/config/chinapay_withdraw_scheduler/jar/chinapay_withdraw_scheduler-standalone.jar /alidata1/backup/chinapay_withdraw_scheduler-standalone-$datestamp.jar
    scp root@10.139.105.230:/mvp-dev/chinapay-withdraw/build/libs/chinapay_withdraw_scheduler-standalone.jar ./playbooks/config/chinapay_withdraw_scheduler/jar/ 
...
{   cp ./playbooks/config/chinapay_withdraw/jar/chinapay_withdraw-standalone.jar /alidata1/backup/chinapay_withdraw-standalone-$datestamp.jar
    scp root@10.139.105.230:/mvp-dev/chinapay-withdraw/build/libs/chinapay_withdraw-standalone.jar ./playbooks/config/chinapay_withdraw/jar/ 
...
function deploy_ums()
{
   ...
   scp root@10.139.105.230:/ums-dev/lastStable/archive/modules/api/build/libs/ums-standalone.jar ./playbooks/config/ums/jar/
...
function deploy_midas()
{
  ...
  # scp root@10.139.105.230:/alidata1/jobs/jiashi_p2p_midas-dev/workspace/modules/persistence/src/main/resources/db/migration/mysql/*.sql ./playbooks/config/midas/sql
   scp root@10.139.105.230:/mvp-dev/jiashi-agreements/build/libs/midas-standalone.jar ./playbooks/config/midas/jar
...
function deploy_front()
{
  ...
  scp root@10.139.105.230:/mvp-dev/jiashi-front/build/libs/midas_front.war ./playbooks/config/midas_front/war
...
function deploy_subject_pass_scheduler()
{
  ...
  scp root@10.139.105.230:/mvp-dev/scheduler/build/libs/subject_pass_scheduler-standalone.jar ./playbooks/config/subject_pass_scheduler/jar/
...
function deploy_subject_shelf_scheduler()
{
  ...
  scp root@10.139.105.230:/mvp-dev/scheduler/build/libs/subject_shelf_scheduler-standalone.jar ./playbooks/config/subject_shelf_scheduler/jar
...
function deploy_midas_admin()
{
  ...
  scp root@10.139.105.230:/mvp-dev/admin/build/libs/midas_admin.war ./playbooks/config/midas_admin/war/
...
function deploy_contract_delivery_scheduler()
{
  ...
  scp root@10.139.105.230:/mvp-dev/scheduler/build/libs/contract_delivery_scheduler-standalone.jar ./playbooks/config/contract_delivery_scheduler/jar/
