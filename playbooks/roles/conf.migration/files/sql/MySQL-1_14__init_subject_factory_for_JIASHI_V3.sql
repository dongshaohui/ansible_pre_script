INSERT INTO POLICY_CODES (TYPE, ACTIVE, CATALOG, OPERATION, CODE) VALUES ('BEGINNER_SUBJECT', 1, 'JIASHI_V3', 'VALIDATE', 'ensure(_$request.config.investProfitFeeRate).is_rate().message("投资收益手续费比例必须大于等于0，小于等于1");
